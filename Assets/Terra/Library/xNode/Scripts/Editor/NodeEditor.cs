...
namespace XNodeEditor {
    ...
    public class NodeEditor : XNodeEditor.Internal.NodeEditorBase<NodeEditor, NodeEditor.CustomNodeEditorAttribute, XNode.Node> {
        ...
        public virtual void OnHeaderGUI() {
            GUILayout.Label(GetTitle(), NodeEditorResources.styles.nodeHeader, GUILayout.Height(30));
        }

        public virtual void OnBodyGUI() {
            OnBodyGUI(new string[0]);
        }

        /// <summary> Draws standard field editors for all public fields </summary>
        public virtual void OnBodyGUI(string[] additionalExcludes) {
#if ODIN_INSPECTOR
            inNodeEditor = true;
#endif
            ...
            List<string> excludes = GetDefaultExcludes().ToList();
        ...
        private string[] GetDefaultExcludes() {
            return new string[] { "m_Script", "graph", "position", "ports" };
